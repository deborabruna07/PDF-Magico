...
* 📝 **Caixa de Texto:** Adicione textos com suporte a diversas fontes (incluindo Google Fonts), cores e tamanhos.
* 🔄 **Controle Total:** Sistema completo de *Undo/Redo* (Desfazer/Refazer), exclusão e rotação de páginas, e Zoom dinâmico.

## 🛠️ Tecnologias Utilizadas

Este projeto foi construído com foco em performance e uma UI/UX impecável, utilizando as melhores ferramentas do ecossistema front-end:
